    ...
    return (
        <div className="realtive mt-20 border-b border-neutral-800 min-h-[800px]">
            <div className="text-center">
                ...
                <h2 className="text-3xl sm:text-5xl lg:text-6xl mt-10 lg:mg-20 tracking-wide">Easily Built <span className="bg-gradient-to-r from-orange-500 to-orange-800 text-transparent bg-clip-text">your code</span></h2>
            </div>
